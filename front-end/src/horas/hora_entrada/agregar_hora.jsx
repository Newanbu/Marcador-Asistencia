...
import { addHoraEntrada, get_user } from "../../endpoints/api";
...
const AgregarHora = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await addHoraEntrada(hora, user.id);
    ...
    return (
        ...
        w="full"
        >
            <Heading size="lg" mb={4} textAlign="center">Registrar Entrada</Heading>
            <FormControl>
